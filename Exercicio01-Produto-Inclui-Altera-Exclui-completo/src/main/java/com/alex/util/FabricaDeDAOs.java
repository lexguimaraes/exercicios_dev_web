...
{	
	...
	{
		// Permite que a gente investigue as classes no package "com.alex.dao.impl"
        Reflections reflections = new Reflections("com.alex.dao.impl");

		// Nesse momento a variável tipo estará valendo Produto.class
		// A linha abaixo verifica se no package "com.alex.dao.impl"
